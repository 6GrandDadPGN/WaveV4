...
```luau
loadstring(game:HttpGet("https://raw.githubusercontent.com/6GrandDadPGN/WaveV4/main/NewMainScript.lua", true))()
```
...
## Developers & Credits
[6GrandDad](https://github.com/6GrandDadPGN) - Lead maintainer of the project
<br/>
...
```
README.md was made by https://github.com/7GrandDadPGN/
```
