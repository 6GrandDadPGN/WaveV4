...
function mainapi:Load(skipgui, profile)
	...
	local guiFile = 'vaperewrite/profiles/'..game.GameId..'.gui.txt'
	...
	local profileFile = 'vaperewrite/profiles/'..self.Profile..(profileId or '')..'.txt'
...
function mainapi:Save(newprofile)
	...
	local guiPath = 'vaperewrite/profiles/' .. game.GameId .. '.gui.txt'
	local profilePath = 'vaperewrite/profiles/' .. self.Profile .. (profileId or '') .. '.txt'
...
local function showPreview(profileName)
	...
	local premadeFile = 'vaperewrite/profiles/premade/'..profileName..profileId..'.txt'
				...
				if profilesCategory:GetValue(profileName) and not confirmedOverwrite then
					...
					conn = loadButton.MouseButton1Click:Connect(function()
						if not stepped then
							...
							writefile('vaperewrite/profiles/'..profileName..profileId..'.txt', premadeData)
